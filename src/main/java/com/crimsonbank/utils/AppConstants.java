...
/**
 * Application-wide constants for configuration, validation, and UI settings.
 */
public final class AppConstants {
    ...
    public static final int NIC_LENGTH = 10; // 9 digits + V/X
    ...
    // Default Values
    public static final int DEFAULT_STAFF_ID = 1; // Admin staff ID
